...
### Immediate.Handlers.Analyzers.Sample
A project that references the sample analyzers. Note the parameters of `ProjectReference` in [Immediate.Handlers.Analyzers.Sample.csproj](../Immediate.Handlers.Analyzers.Sample/Immediate.Handlers.Analyzers.Sample.csproj), they make sure that the project is referenced as a set of analyzers. 

### Immediate.Handlers.Analyzers.Tests
