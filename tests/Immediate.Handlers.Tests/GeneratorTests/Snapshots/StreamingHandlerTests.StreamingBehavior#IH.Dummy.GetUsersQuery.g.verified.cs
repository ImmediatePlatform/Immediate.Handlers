...
partial class GetUsersQuery
{
	...
	{
		global::Microsoft.Extensions.DependencyInjection.Extensions.ServiceCollectionDescriptorExtensions.TryAddTransient(services, typeof(global::Dummy.LoggingBehavior<global::Dummy.GetUsersQuery.Query, int>));
		...
		global::Microsoft.Extensions.DependencyInjection.Extensions.ServiceCollectionDescriptorExtensions.TryAdd(
			services,
			global::Microsoft.Extensions.DependencyInjection.ServiceDescriptor.Describe(
				typeof(global::Immediate.Handlers.Shared.IStreamingHandler<global::Dummy.GetUsersQuery.Query, int>),
				typeof(global::Dummy.GetUsersQuery.Handler),
				lifetime
			)
		);
